...
public:
    Policy1(Stats & s, std::vector<Segment> & responses, Downloader & d): BasePolicy(s, responses, d){}
...
public:
    ...
    Policy2(Stats & s, std::vector<Segment> & responses, Downloader & d, unsigned short k_param):
